        ...
        for batch in pbar:
            ...
            with torch.autocast("cuda", dtype=mp_dtype, enabled=mp_enabled):
                with Timer("forward", times):
                    ...
                    pred = model(noisy_model_input, timesteps/1000, encoder_hidden_states=dummy_enc_states, timestep_cond=conditions, return_dict=False)[0]
                ...
                with torch.no_grad():
                    with torch.autocast("cuda", dtype=mp_dtype, enabled=mp_enabled):
                        ...
                        for i, t in enumerate(noise_scheduler.timesteps):
                            pred = model(latents, t/1000, encoder_hidden_states=dummy_enc_states, timestep_cond=conditions, return_dict=False)[0]
